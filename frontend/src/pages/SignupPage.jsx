  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Stay on signup page if not authenticated
      }
    };
    checkAuth();
  }, [from, navigate]);
          ...
          <div className="hidden md:flex relative overflow-hidden rounded-xl border border-brand-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-8">
            <div className="relative z-10 my-auto">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-400">
                Join thousands of users taking control of their wellness with AI-powered insights.
              </p>
              <ul className="mt-6 space-y-3 text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300">
                    ✓
                  </span>
                  Free account creation
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
                    ✓
                  </span>
                  End-to-end data privacy
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-300">
                    ✓
                  </span>
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="mt-1 text-slate-600 dark:text-slate-400">
                Get started with Health Sphere in seconds.
              </p>
            </div>
            <Card>
              <CardContent>
                {error && (
                  <div
                    role="alert"
                    className="mb-3 text-sm rounded-md border border-red-200 bg-red-50 px-3 py-2 text-red-700 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-300"
                  >
                    {error}
                  </div>
                )}
